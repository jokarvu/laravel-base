        ...
        <div class="row gap-20">
            <div class="col-md-12">
                <div class="bgc-white p-20 bd">
                    <h4 class="c-grey-900 mB-20">Update Role</h4>
                    <div class="mT-30">
                        <form class="container" @submit.prevent="updateRole">
                            <div class="row">
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            axios.get('/api/role/'+slug+'/edit').then(response => {
                this.role = response.data.role;
                this.permissions = response.data.permissions;
                response.data.checked.forEach(item => {
            ...
            updateRole () {
                ...
                app.$validator.validateAll().then(validated => {
                    if (!validated) {
                        ...
                        axios.put('/api/role/' + app.role.id, {'name': app.role.name, 'description': app.role.description, 'permissions': app.checked}).then(json => {
