        ...
        <div class="row gap-20">
            <div class="col-md-12">
                <div class="bgc-white p-20 bd">
                    <h4 class="c-grey-900 mB-20">Add Permission</h4>
                    <div class="mT-30">
                        <form class="container" @submit.prevent="addPermission">
                            <div class="row">
            ...
            addPermission () {
                ...
                app.$validator.validateAll().then(validated => {
                    if (!validated) {
                        ...
                        axios.post('/api/permission', {'name': app.permission.name, 'description': app.permission.description, 'checked': app.checked}).then(json => {
